    ...
    return (
        <div className='bg-[#FDFDFD]'>
            <div className='flex items-center justify-between mb-6'>
                <h1 className='text-2xl font-bold text-[#101928] mb-4'>Event Details</h1>
                <div>
                    <button className='bg-[#FFFFFF] py-2 text-[#FA4B08] rounded-full border border-[FDDED2] px-6'>Decline</button>
                ...
                <div className='col-span-6 bg-[#F9FAFB] p-4 rounded-lg'>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <Card className='bg-[#FFFFFF] border-0 rounded-lg p-4'>
                            <CardHeader>
                                <CardTitle className='text-sm text-gray-500'>Event Date</CardTitle>
                            </CardHeader>
                            <CardContent className='flex items-center text-gray-600 gap-4'>24th Sep, 2025</CardContent>
                        </Card>
                        ...
                        <Card className='bg-[#FFFFFF] rounded-lg p-4'>
                            ...
                            <CardContent className='flex items-center text-gray-600 gap-4'>4:00pm</CardContent>
                        </Card>
                    </div>
                    ...
                    <Card className='bg-[#FFFFFF] rounded-lg p-4'>
                        ...
                        <CardContent className=' text-[#2E5343] text-lg font-bold gap-4'>₦1,5000,000</CardContent>
                    </Card>
